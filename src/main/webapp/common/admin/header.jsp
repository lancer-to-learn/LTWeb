	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.html"> <img
				src="${ url }/admin/layout/img/logo.png" alt="logo"
				class="logo-default" />
			</a>
		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user"><c:choose>
						<c:when test="${fn:contains(acc.image, 'https')}">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"
								data-hover="dropdown" data-close-others="true"> <img alt=""
								class="img-circle" src="${ sessionScope.acc.image }" /> <span
								class="username username-hide-on-mobile"> ${ sessionScope.acc.user }
						...
						<c:otherwise>
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"
								data-hover="dropdown" data-close-others="true"> <img alt=""
								class="img-circle" src="${ imgUrl }" /> <span
								class="username username-hide-on-mobile"> ${ sessionScope.acc.user }
							</span> <i class="fa fa-angle-down"></i>
							</a>
						</c:otherwise>
