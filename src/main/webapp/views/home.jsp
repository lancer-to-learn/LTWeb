		...
		<div class="fullwidthabnner">
			<ul id="revolutionul">
				...
				<li data-transition="fade" data-slotamount="8"
					...
					data-thumb="${ url }/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
					<!-- THE MAIN IMAGE IN THE FIRST SLIDE --> <img
					src="${ url }/frontend/pages/img/revolutionslider/bg9.jpg" alt="">
					...
					<div class="caption lfb" data-x="640" data-y="0" data-speed="700"
						...
						<img src="${ url }/frontend/pages/img/revolutionslider/lady.png"
							alt="Image 1">
					</div>
				</li>
				...
				<li data-transition="fade" data-slotamount="8"
					...
					data-thumb="${ url }/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
					<!-- THE MAIN IMAGE IN THE FIRST SLIDE --> <img
					src="${ url }/frontend/pages/img/revolutionslider/bg1.jpg" alt="">
					...
					<div class="caption lfb" data-x="640" data-y="55" data-speed="700"
						data-start="1000" data-easing="easeOutExpo">
						<img
							src="${ url }/frontend/pages/img/revolutionslider/man-winner.png"
							alt="Image 1">
					</div>
				</li>
				...
				<li data-transition="fade" data-slotamount="7"
					...
					data-thumb="${ url }/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
					<img src="${ url }/frontend/pages/img/revolutionslider/bg2.jpg"
					alt="">
					...
					<div class="caption lfb slide_item_right" data-x="355" data-y="355"
						...
						<img
							src="${ url }/frontend/pages/img/revolutionslider/hint2-red.png"
				...
				<li data-transition="fade" data-slotamount="8"
					data-masterspeed="700" data-delay="9400"
					data-thumb="${ url }/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
					<img src="${ url }/frontend/pages/img/revolutionslider/bg3.jpg"
					alt="">
				...
				<li data-transition="fade" data-slotamount="8"
					...
					data-thumb="${ url }/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
					<!-- THE MAIN IMAGE IN THE FIRST SLIDE --> <img
					src="${ url }/frontend/pages/img/revolutionslider/bg4.jpg" alt="">
					...
					<div class="caption lft start" data-x="670" data-y="55"
						...
						<img
							src="${ url }/frontend/pages/img/revolutionslider/iphone_left.png"
							alt="Image 2">
					</div>
					...
					<div class="caption lft start" data-x="850" data-y="55"
						...
						<img
							src="${ url }/frontend/pages/img/revolutionslider/iphone_right.png"
							alt="Image 3">
					</div>
				</li>
			</ul>
  ...
  <div id="layerslider" style="width: 100%; height: 494px; margin: 0 auto;">
    ...
    <div class="ls-slide ls-slide1" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 24,25,27,28;">
      ...
      <div class="ls-l ls-title" style="top: 96px; left: 35%; white-space: nowrap;" data-ls="
        ...
        scaleout: .5; 
        showuntil: 4000;
      ">Welcome <strong>To </strong>Laptop UTE</div>
      ...
      delayin: 300; 
      showuntil: 4000;
      ">From <br  >Nguyễn Anh Tuấn aka NAT<br > Đỗ Cao Minh Chí
      </div>
    </div>
    <!-- slide one end -->
    ...
    <div class="ls-slide ls-slide2" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 110,111,112,113;">
      ...
      scalein: .8; 
      scaleout: .8; 
      showuntil: 4000;"><b>from</b> <strong><span>$</span>100</strong>
      </div>
    </div>
    <!-- slide two end -->
    ...
    <div class="ls-slide ls-slide3" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 92,93,105;">
      ...
      scaleout: .5; 
      showuntil: 4000;
      ">Ecommerce &amp; More <strong>LAPTOP UTE</strong> Is Ready For You
      </div>
    ...
    <div class="ls-slide ls-slide4" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 110,111,112,113;">
      ...
      scaleout: .8; 
      showuntil: 4000;">
      <span>Only available for a limited time</span>
      <a href="">Get It Now!</a>
      </div>
...
<div class="main">
	<div class="container">
				...
				<div class="owl-carousel owl-carousel4">
					<c:forEach items="${newestProduct }" var="np">
						<div>
							<div class="product-item">
								<div class="pi-img-wrapper">
									<img src="${np.pImage}" class="img-responsive img-fluid"
										alt="${np.pName}">
								</div>
								<h3 class="text-center text-danger">
				...
				<div class="owl-carousel owl-carousel4">
					<c:forEach items="${sallestProduct }" var="sp">
						<div>
							<div class="product-item">
								<div class="pi-img-wrapper">
									<img src="${sp.pImage}" class="img-responsive"
										alt="${sp.pName}">
								</div>
								<h3 class="text-center text-danger">
				...
				<div class="tab-content">
					<div class="tab-pane row fade in active" id="tab-1">
						<div class="col-md-3 col-sm-3">
							<a href="assets/temp/photos/img7.jpg" class="fancybox-button"
								title="Image Title" data-rel="fancybox-button"> <img
								class="img-responsive"
								src="${ url }/frontend/pages/img/photos/img7.jpg" alt="">
							</a>
						</div>
					...
					<div class="tab-pane row fade" id="tab-2">
						...
						<div class="col-md-3 col-sm-3">
							<a href="assets/temp/photos/img10.jpg" class="fancybox-button"
								title="Image Title" data-rel="fancybox-button"> <img
								class="img-responsive"
								src="${ url }/frontend/pages/img/photos/img10.jpg" alt="">
							</a>
						</div>
					</div>
					...
					<div class="carousel-inner">
						<div class="active item">
							...
							<div class="carousel-info">
								<img class="pull-left"
									src="${ url }/frontend/pages/img/people/img1-small.jpg" alt="">
								<div class="pull-left">
						...
						<div class="item">
							<blockquote>
								<p>Raw denim you Mustache cliche tempor, williamsburg carles
									vegan helvetica probably haven't heard of them jean shorts
							...
							<div class="carousel-info">
								<img class="pull-left"
									src="${ url }/frontend/pages/img/people/img5-small.jpg" alt="">
								<div class="pull-left">
						...
						<div class="item">
							<blockquote>
								<p>Reprehenderit butcher stache cliche tempor, williamsburg
									carles vegan helvetica.retro keffiyeh dreamcatcher synth. Cosby
									sweater eu banh mi, qui irure terry richardson ex squid Aliquip
									placeat salvia cillum iphone.</p>
							</blockquote>
							<div class="carousel-info">
								<img class="pull-left"
									src="${ url }/frontend/pages/img/people/img2-small.jpg" alt="">
								<div class="pull-left">
		...
		<div
			...
			<div class="col-md-4 col-sm-4 front-step-col">
				<div class="front-step front-step1">
					...
					<p>Lorem ipsum dolor sit amet sit consectetur adipisicing
						eiusmod tempor.</p>
				</div>
			</div>
			<div class="col-md-4 col-sm-4 front-step-col">
		...
		<div class="row margin-bottom-40 our-clients">
			<div class="col-md-3">
				<h2>
					<a href="#">Thương hiệu hàng đầu</a>
				</h2>
				<p>Thương hiệu tốt mang đến cho bạn những sản phẩm chất lượng và trải nghiệm dùng tốt nhất.</p>
			</div>
			<div class="col-md-9">
