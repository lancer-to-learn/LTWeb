		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="list-product">Products</a></li>
				</ul>
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<tbody>
										...
										<tr role="row" class="filter">
											<td>${product.pId}</td>
											<td><c:choose>
													<c:when test="${fn:contains(product.pImage, 'https')}">
														<img class="img-responsive center" src="${product.pImage}"
															style="width: 100px; height: 100px;" alt="Image Error">
													</c:when>
													<c:otherwise>
														<c:url value="/admin/image?fname=${product.pImage}"
															var="imgUrl"></c:url>
											...
											<a class="center"
												...
												<a class="center"
													href="${pageContext.request.contextPath}/admin/delete/list-product?id=${product.pId}">
