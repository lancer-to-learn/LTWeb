...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
				Brands <small>brand listing</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li><i class="fa fa-home"></i> <a
						href="${pageContext.request.contextPath}/admin">Home</a> <i
						class="fa fa-angle-right"></i></li>
					<li><a href="list-brand" class="active">Brands</a></li>
				</ul>
									...
									<tbody>
										<c:forEach items="${brands}" var="brand">
											<tr role="row" class="filter">
												...
												<td>
													<c:choose>
													<c:when test="${fn:contains(brand.bImage, 'https')}">
														
														<img class="img-responsive center" src="${brand.bImage}"
															style="width: 100px; height: 100px;" alt="Image Error">
													</c:when>
													<c:otherwise>
													<c:url value = "/admin/image?fname=${brand.bImage}" var = "imgUrl"></c:url>
												...
												<td>
												<a class="center"
													href="${pageContext.request.contextPath}/admin/edit/list-brand?id=${brand.bId}">
													<button class="btn btn-sm yellow filter-submit">
														<i class="fa fa-search"></i> Edit
													</button> 
													</a>
													<a class="center"
													href="${pageContext.request.contextPath}/admin/delete/list-brand?id=${brand.bId}">
